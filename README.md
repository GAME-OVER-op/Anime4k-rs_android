...
- Видео-режим: выбрать видео → разобрать на PNG → параллельно улучшить кадры через Rust → собрать MP4 через FFmpegKit.
...
- **CRF** — качество libx264, меньше = лучше/больше файл.
